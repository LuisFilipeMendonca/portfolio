      ...
      <ProjectContainer>
        ...
        <ProjectInformation>
          ...
          <ProjectDescriptionContainer>
            ...
            <ProjectDescription>
              In this application you can register and login into your account.
              Manage your contacts list by adding and removing them as well as
              your schedule using the task manager.
            </ProjectDescription>
            <ProjectDescription>
      ...
      <ProjectContainer>
        ...
        <ProjectInformation>
          ...
          <ProjectDescriptionContainer>
            ...
            <ProjectDescription>
              In this application you can register, login and ask for a password
              reset if you forget it. Here you will find a bunch of recipies
              where you can see the ingredients and also the steps to make them.
              You can also create or delete your own recipies, add recipies from
              other users to your favorites and also rate them.
            </ProjectDescription>
            <ProjectDescription>
              You will also find features like search a recipie by name, order
              them by date or rate and also choose how many recipies you want to
              see per page.
            </ProjectDescription>
          </ProjectDescriptionContainer>
          <ProjectCTA>
